...
;   3.0 3/12/2026 	Modified for TA Alphatronic PC
;					- UART BIOS calls
;					- compiled with zasm --z80 --asm8080 --reqcolon --dotnames
;  					by Jukka Savolainen
...
INIT_ACIA:
	; boot rom initializes the UART, so we don't need to do anything here
	; ... but we could add code here to change the baud rate, etc. if we wanted to
	ret
...
mHelp:	.db	CR,LF,"PCGET 3.0 for TA Alphatronic PC",CR,LF,LF
